    ...
    <div class="step">
        <div class="container">
            ...
            <div class="row ticket-status">
                <div class="col-md-12">
                    <div class=" col-md-12 status-head">
                        TICKET ID: 123456                            
                    </div>                        
                </div>
                ...
                <div class="col-md-12 ticket-row">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="status-right">
                            <div class="col-md-4">
                                <div class="right-btn" style="background-color: rgba(255, 255, 255, .2);">
                                    ADD TECHNICIAN
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="right-btn"  style="background-color: #d01820;">
                                    DELETE TICKET
                                </div>
                            </div>                            
                        </div>
